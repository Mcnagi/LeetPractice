...
public class Q0018Test {
    public void test(List<List<Integer>> expected, int[] array, int target) {
        ...
        Assertions.assertTrue(expected.containsAll(actual)
                ...
                String.format("Expect to have %s but got %s with input: %s", expected, actual, Arrays.toString(array)));
    }
    ...
    public void testHard() {
        ...
        test(answer, new int[]{0,0,0,1_000_000_000,1_000_000_000,1_000_000_000,1_000_000_000}, 1_000_000_000);
    }
}
