...
public class Q0010Test {
  public void testTrue(String s, String pattern) {
    ...
    Assertions.assertTrue(
        q10.isMatch(s, pattern), String.format("with input %s and pattern %s", s, pattern));
  }
  ...
  public void testOne() {
    ...
    for (int i = 0; i < ss.length; i++) testTrue(ss[i], patterns[i]);
    for (int i = 0; i < 26; i++) testTrue(String.valueOf((char) ('a' + i)), ".");
    for (int i = 0; i < 26; i++)
  ...
  public void testLong() {
    ...
    String[] patternsTrue1 =
        new String[] {"abcads", "bbbbbbb", "ccsaad", "abcdefg", "aabbccd", "aabbccdeeee"};
    String[] patternsTrue2 =
        new String[] {"abcads", "b*", "c*sa*d", "abcdefg", "a*b*c*d", "a*b*c*de*"};
    String[] patternsTrue3 =
        new String[] {"abcads*", "b*", "c*s*a*d*", "a*b*c*d*e*f*g*", "a*b*c*d*", "a*b*c*d*e*"};
    String[] patternsFalse1 =
        new String[] {"abcad", "bbbb", "ccsaa", "abcdef", "a*b*c*", "a*b*c*de"};
