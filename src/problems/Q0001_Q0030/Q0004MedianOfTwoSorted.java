...
public class Q0004MedianOfTwoSorted {
  ...
  /**
   * Get the value from the array that is closest to target.
   *
   * @param target the value needs to approximate
   * @param array integers to look into
   * @param fromLeft 1 for larger or equal to target, -1 for smaller or equal to target, no good
   *     with 0;
   */
  @Deprecated
  ...
  //    }
  /**
   * @return -1 if and only if length is 0; the correct index bounded by length.
   */
